function [segSNR,Csig,Cbak,Covl,pesq_mos]= composite(cleanFile, enhancedFile,k)
...
%  [pesq_mos]= pesq(Srate1,cleanFile, enhancedFile);
 [~,strout]=system(['PESQ ','+16000',' ',cleanFile,' ',enhancedFile]);
lastFiveChars = strout(end-5:end-1);
pesq_mos = str2double(lastFiveChars);
...
fprintf('\n LLR=%f   SNRseg=%f   WSS=%f   PESQ=%f k=%d\n',llr_mean,segSNR,wss_dist,pesq_mos,k);
